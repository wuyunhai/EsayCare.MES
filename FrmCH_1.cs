...
namespace EsayCare.MES
{
    ...
    public partial class FrmCH_1 : Form
    {
        #region var
        ...
        private void GetBoxWorkOrderInfo(string workOrder, string sn)
        {
            try
            {
                ...
                lblPro.Text = dt.Rows[0]["CH_Attribute"].ToString();
                lblType.Text = dt.Rows[0]["CH_type"].ToString();
                lblSN.Text = dt.Rows[0]["CH_Order"].ToString();

                SerialNumber = dt.Rows[0]["CH_Order"].ToString();
                cpbCount.Text = dt.Rows[0]["SumQTY"].ToString();
                cpbCountP.Text = dt.Rows[0]["CompleteQTY"].ToString();
                cpbCountU.Text = dt.Rows[0]["WaitQTY"].ToString();
